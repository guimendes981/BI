...
## OBJETIVOS DA PROVA
    ...
    -LER O PLANO DE AULAS DA MATÉRIA

    -RELACIONAR DISTINTOS CENARIOS A APLICACAO DE OLAP OU OLTP

    -DESENHAR MODELAGENS DE DATA WAREHOUSE

    -FAZER O DASHBOARD COMO VC MOSTRARIA PARA O CLIENTE

    -DE ACORDO COM A MATRIZ DIMENSAO X INDICADOR

    -VAI SER PASSADO O TEMA? VAI EXISTIR UM BANCO DE DADOS E UM TEXTO COMO APOIO 

    -A PARTE TEORICA É OBJETIVA, VAI SER SOBRE OLAP, OLTP E ETL
